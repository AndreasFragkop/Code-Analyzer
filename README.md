...
- Copy Result button (full report: language, confidence, stats, patterns, alternatives)
...
2. Press `Enter` to analyze (use `Shift+Enter` to add a new line), or click `Detect Language`.
